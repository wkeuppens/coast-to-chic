        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-14">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: yearData.length * 0.1 }}>
              <p className="text-2xl md:text-3xl text-foreground tabular-nums mb-3">2026</p>
              <div className="relative border-l border-border/40 pl-6 ml-1 space-y-3">
                <div className="absolute -left-[3.5px] top-[7px] w-[7px] h-[7px] rounded-full border border-accent bg-transparent" />
                <div className="flex flex-wrap gap-x-6 gap-y-1 text-sm text-muted-foreground">
