...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      'Standard handover: 07:00',
      'Even if you finish early, the symbolic handover remains essential.',
      'At that moment, the journey passes from one group to another.',
      'This ritual keeps the project alive.',
    ],
  },
  {
    number: '9',
    ...
    content: ['At 07:00:'],
    list: [
      'the finishing and starting teams meet',
      'the Token is transferred',
      'physical presence matters',
    ],
    after: [
      'No shortcuts.\nNo symbolic substitutes.',
      'The continuity between people is the heart of Follow the Coast.',
    ],
  },
  {
    number: '10',
