...
const TourDuMontBlanc = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Quick facts — compact, light border style */}
        ...
        <div className="max-w-3xl mx-auto">
          <motion.div {...fadeUp}>
            ...
            <div className="space-y-5 text-muted-foreground leading-relaxed">
              ...
              <p>
                Guides, luggage transfers, and overnight lodging are arranged for you.
                You carry what you need for the day. The rest follows.
              </p>
            </div>
          </motion.div>
        </div>
