    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <header className="px-6 md:px-12 py-6">
        <Link to="/" className="flex items-center gap-3">
          <img src={wavesLogo} alt="Follow the Coast logo" className="h-8 w-auto" />
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        ...
        >
          <p className="text-sm text-muted-foreground tracking-wide mb-4">All Stages</p>
          <h1 className="text-4xl md:text-5xl font-medium mb-6">
            Coming Soon
          </h1>
          <p className="text-muted-foreground leading-relaxed mb-8">
            The full stage directory is being prepared. Check back soon for complete listings.
          </p>
          <Link 
            to="/"
